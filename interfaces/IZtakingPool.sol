...
interface IZtakingPool {
    ...
    ///@notice Returns a value based on whether asset is supported by the staking contract
    ///@param asset Token being checked
    function tokenAllowlist(address asset) external view returns (bool);
